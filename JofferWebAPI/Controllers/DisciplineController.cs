...
//        // GET: api/Discipline
//        [HttpGet]
//        public async Task<ActionResult<IEnumerable<Role>>> GetDiciplines()
//        {
...
//        [HttpGet("{id}")]
//        public async Task<ActionResult<Role>> GetDicipline(int id)
//        {
//          if (_context.Diciplines == null)
//          {
//              return NotFound();
...
//        // PUT: api/Dicipline/5
//        [HttpPut("{id}")]
//        public async Task<IActionResult> PutDicipline(int id, RoleDto diciplineDto)
//        {
//            Role dicipline = new(diciplineDto)
//            {
//                Id = id
//            };
...
//        // POST: api/Dicipline
//        [HttpPost]
//        public async Task<ActionResult<RoleDto>> PostDicipline(RoleDto diciplineDto)
//        {
//            if (_context.Diciplines == null)
//            {
...
//            _context.Diciplines.Add(new Role(diciplineDto));
//            await _context.SaveChangesAsync();
